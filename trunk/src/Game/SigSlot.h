...
//		typedef sender_set::const_iterator const_iterator;
	...
	public:
		...
		{
			lock_block<mt_policy> lock(this);
			std::set<_signal_base<mt_policy> *>::const_iterator/*const_iterator*/ it = m_senders.begin();
			std::set<_signal_base<mt_policy> *>::const_iterator/*const_iterator*/ itEnd = m_senders.end();
	...
	private:
		std::set<_signal_base<mt_policy> *>/*sender_set*/ m_senders;
	};
...
#define NEW_SIGNAL3( name, arg0, arg1, arg2 )	\
	private:						\
...
#define NEW_SIGNAL4( name, arg0, arg1, arg2, arg3 )	\
	private:						\
...
#define NEW_PRIVATE_SIGNAL1( name, arg0 )	\
	private:						\
	signal1<arg0> m_sig##name;		\
	public:							\
	template<class desttype>	\
...
#define NEW_PRIVATE_SIGNAL2( name, arg0, arg1 )	\
	private:						\
	signal2<arg0,arg1> m_sig##name;		\
	public:							\
	template<class desttype>	\
...
#define NEW_PRIVATE_SIGNAL3( name, arg0, arg1, arg2 )	\
	private:						\
	signal3<arg0,arg1,arg2> m_sig##name;		\
	public:							\
	template<class desttype>	\
...
#define NEW_PRIVATE_SIGNAL4( name, arg0, arg1, arg2, arg3 )	\
	private:						\
	signal4<arg0,arg1,arg2,arg3> m_sig##name;		\
	public:							\
	template<class desttype>	\
